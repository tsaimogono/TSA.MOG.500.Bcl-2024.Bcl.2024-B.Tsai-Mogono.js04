...
// Using a ternary operator to check user preference and print the appropriate message
console.log(`User prefers ${userPreference === 'Sugar-free' ? 'Sugar-free' : 'Regular'} variety.`);
...
// Using a ternary operator to check the number of cans left and print the appropriate message
...
// Using a ternary operator to check the current temperature and print the appropriate message
